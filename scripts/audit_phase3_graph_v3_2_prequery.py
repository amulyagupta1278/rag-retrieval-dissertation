#!/usr/bin/env python3
"""Post-freeze checks that cannot influence v3.2 index or ranking."""
...
def main() -> None:
    ...
    approved = (
        ...
        (ROOT / "runs/v2/phase3_graph_v3_2/index/chunk_entities.json").resolve(),
        (ROOT / "runs/v2/phase3_graph_v3_2/index_freeze_manifest.json").resolve(),
        (ROOT / "audits/phase3_graph_v3_2/prequery_protected_and_gold_isolation.json").resolve(),
    )
    ...
    v31_freeze = json.loads((ROOT / "runs/v2/phase3_graph_v3_1/index_freeze_manifest.json").read_text(encoding="utf-8"))
    v31_retrieval = json.loads((ROOT / "runs/v2/phase3_graph_v3_1/retrieval_manifest.json").read_text(encoding="utf-8"))
    v31_actual = {
        "config": sha256_file(ROOT / "configs/entity_graph_v3_1_frozen.json"),
        "registry": sha256_file(ROOT / "data/v2/pilot/graph/entity_registry_v3_1.jsonl"),
        "chunk_entities": sha256_file(ROOT / "runs/v2/phase3_graph_v3_1/index/chunk_entities.json"),
        "edges": sha256_file(ROOT / "runs/v2/phase3_graph_v3_1/index/edges.jsonl"),
        "nodes": sha256_file(ROOT / "runs/v2/phase3_graph_v3_1/index/nodes.jsonl"),
        "top50": sha256_file(ROOT / "runs/v2/phase3_graph_v3_1/rankings/graph_v3_1_top50.jsonl"),
        "top10": sha256_file(ROOT / "runs/v2/phase3_graph_v3_1/rankings/graph_v3_1_top10.jsonl"),
        "traces": sha256_file(ROOT / "runs/v2/phase3_graph_v3_1/traces/graph_v3_1_full_traces.jsonl"),
        "trace_decision": sha256_file(ROOT / "audits/phase3_graph_v3_1/trace_validity_decision.json"),
    }
    v31_expected = {
        "config": v31_freeze["configuration_sha256"],
        "registry": v31_freeze["registry_sha256"],
        "chunk_entities": v31_freeze["artifact_hashes"]["runs/v2/phase3_graph_v3_1/index/chunk_entities.json"],
        "edges": v31_freeze["artifact_hashes"]["runs/v2/phase3_graph_v3_1/index/edges.jsonl"],
        "nodes": v31_freeze["artifact_hashes"]["runs/v2/phase3_graph_v3_1/index/nodes.jsonl"],
        "top50": v31_retrieval["raw_artifact_hashes"]["runs/v2/phase3_graph_v3_1/rankings/graph_v3_1_top50.jsonl"],
        "top10": v31_retrieval["raw_artifact_hashes"]["runs/v2/phase3_graph_v3_1/rankings/graph_v3_1_top10.jsonl"],
        "traces": v31_retrieval["raw_artifact_hashes"]["runs/v2/phase3_graph_v3_1/traces/graph_v3_1_full_traces.jsonl"],
        "trace_decision": "03360b1d11b09b70c398f66532e4f49f36065863fb9c78c80d3c82716e5b9181",
    }
    if v31_actual != v31_expected:
        raise RuntimeError("failed v3.1 retrieval artifacts changed")
    ...
    audit = {
        ...
        "protected": {
            ...
            "phase3_v3_1": v31_actual,
            "phase3_v3_1_classification": "invalid_trace_gate_alias_completeness_failure",
